...
class VideoStreamStats(db.Model):
    ...
    timing_source = db.Column(db.Text)
    first_offset_seconds = db.Column(db.Float)
    last_offset_seconds = db.Column(db.Float)
    out_of_range_messages = db.Column(db.BigInteger, nullable=False, default=0)
    quiet_tail_seconds = db.Column(db.Float)
